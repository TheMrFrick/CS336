...
<body>
	<%
		...
		if ("yes".equals(delete)) {
			ApplicationDB.deleteUser(username);
		}
	%>
	...
	<div class="container">
		...
		<table>
			...
			<tr>
				...
				<td><a href="user.jsp?user=<%=rs.getString("username")%>">View</a></td>
				<td><a
					href="admin.jsp?delete=yes&user=<%=rs.getString("username")%>">Delete</a></td>
			</tr>
			<%
				}
					rs.close();
