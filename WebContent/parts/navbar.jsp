...
<ul class="navbar">
	...
	<li style="float: right"><a href="admin.jsp?delete=no&user=admin">Admin Page</a>
...
<ul class="navbar">
	...
	<li><a href="browse.jsp">Browse</a></li>
	<li style="float: right"><a href="logout.jsp">Logout</a></li>
	<li style="float: right"><a href="user.jsp?user=<%=user%>">My
			Account</a>
	<li style="float: right"><a href="search.jsp">Search</a></li>
	<li style="float: right"><a href="addItem.jsp">add Item</a></li>
	<li style="float: right"><a href="browse.jsp">Browse</a></li>
...
<ul class="navbar">
	...
	<li style="float: right"><a href="browse.jsp">Browse</a> <!-- 		<li><a href="about.asp">About</a></li> -->
</ul>
<%
	}
%>
